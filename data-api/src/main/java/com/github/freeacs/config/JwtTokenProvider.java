...
public class JwtTokenProvider {
    ...
    public String createToken(String username, UserDto userDto) {
        Claims claims = Jwts.claims().setSubject(username);
        claims.put("roles", userDto.getAccessList().asJava());
        claims.put("permissions", userDto.getPermissions().asJava());
        Date now = new Date();
